...
class CocoClsDataset(data.Dataset):
    def __init__(self, root_dir, ann_file, img_dir, bg_bboxes_file, phase, less_sample=False):
    ...
    def _mining_sample(self):
        ...
        num_bg_anns = 30000
        tmp_bg_anns = self.bg_anns[::len(self.bg_anns) // num_bg_anns]
